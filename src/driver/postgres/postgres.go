...
type PostgresConfig struct {
	Addr     string `env:"ZWEB_PG_ADDR" envDefault:"localhost"`
	Port     string `env:"ZWEB_PG_PORT" envDefault:"5433"`
	User     string `env:"ZWEB_PG_USER" envDefault:"zweb_cloud"`
	Password string `env:"ZWEB_PG_PASSWORD" envDefault:"zweb2022"`
	Database string `env:"ZWEB_PG_DATABASE" envDefault:"zweb_cloud"`
}
